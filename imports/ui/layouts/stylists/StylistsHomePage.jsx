...
const StylistsHomepage = props => (
  <Container style={{ padding: "8rem 0" }}>
    ...
    <p>
      ...
      doloribus non libero. Velit explicabo eligendi possimus. Quia ab
      quibusdam. Nobis ducimus dolorem culpa deleniti commodi velit voluptates.
      Est quia voluptates optio impedit. Eum ut est ut eligendi sed quis.
      Sapiente dolor eius eos rem magni.
    </p>
