  ...
  <Segment style={{ padding: "8em 0em" }} vertical inverted>
    <Container text>
      ...
      <p style={{ fontSize: "1.33em" }}>
        ...
        veniam. Quae aspernatur delectus. Aut laboriosam in et eius nam quas
        est. Porro sunt commodi dolorem exercitationem tempore aspernatur quasi.
      ...
      <Divider horizontal inverted style={{ margin: "3em 0em" }}>
        case studies
      </Divider>
      ...
      <p style={{ fontSize: "1.33em" }}>
        Ipsa deleniti vel. Ut non consectetur. Maxime vel repudiandae. Possimus
        hic quos. Fugiat quis culpa. Non aut doloremque qui beatae dolor alias
        omnis. Rerum adipisci vel dignissimos quia consectetur. Voluptas ipsam
        sunt rerum ipsam illo accusamus porro error nam.
      </p>
      <Button as="a" size="large" inverted>
