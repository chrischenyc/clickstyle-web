...
const PrivacyPage = () => (
  <Container className="margin-top-40 margin-bottom-40">
    ...
    <p>
      ...
      under {Meteor.settings.public.legalName}. Merchant trademarks are the property of the
      ...
      us collecting, storing, using, and disclosing your personal information in the manner set out
    ...
    <p>
      Collecting your personal information: We may collect personal information from you (including,
      without limitation, your name, email address, phone number, and postal address) when you use
      this website. You may decide not to provide your personal information to us. However, if you
      do not provide it, we may not be able to provide you with access to certain information or
      products.
    </p>
    <p>
      ...
      order to improve this website). Except as set out in this privacy policy, we will not disclose
      any such information except in aggregate form.
    </p>
    <p>
    ...
    <p>
      ...
      functionality. Cookies and sessions may be used to identify you as an individual user of this
      website. We use this technology to, amongst other things. Accepting a cookie will not give us
      access to any data on your computer other than the data stored in the cookie. Although you may
      configure your web browser to not accept cookies, you may experience a loss of functionality
      as a result.
    </p>
    <p>
      ...
      information regarding website use. You may choose to decline cookies generally if your browser
      permits, but doing so may affect your use of the website and your ability to access certain
      features of the Website.
    </p>
    <p>
      Security: We are ceaselessly executing and refreshing regulatory, specialized, and physical
      safety efforts to help secure your data against unapproved access, misfortune, devastation, or
      change. In any case, the Internet isn&apos;t a 100% secure place so we can&apos;t ensure the
      security of the transmission or safety of your data.
    </p>
    <p>
    ...
    <p>
      Changes to this Privacy Policy {Meteor.settings.public.appName} may change its Privacy Policy
      ...
      Policy. Your proceeded utilization of the Services after any adjustment in this Privacy Policy
      will constitute your acknowledgement of such change.
    </p>
