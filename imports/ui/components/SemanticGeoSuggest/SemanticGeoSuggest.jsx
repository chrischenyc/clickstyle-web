 ...
 */
class SemanticGeoSuggest extends React.Component {
  /**
  ...
  constructor(props) {
    ...
    if (props.queryDelay) {
      this.onAfterInputChange = _.debounce(this.onAfterInputChange, props.queryDelay);
    }
  }
 ...
 * @type {Object}
 */
SemanticGeoSuggest.propTypes = propTypes;
